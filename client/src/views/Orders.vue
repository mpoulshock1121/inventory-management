<template>
  <div class="orders">
    ...
    <div v-else>
      ...
      <!-- Submitted restocking orders — fetched without global filters so they always appear -->
...
export default {
  ...
  setup() {
    ...
    // Restocking orders fetched independently so they show regardless of active filters
